          ...
          >
            <g transform={`translate(${strokeWidth}, ${outerAreaSize + strokeWidth})`}>
              <line
                ...
                strokeWidth="1"
                strokeLinecap="round"
                x1={this.startCoordinate[0]}
                y1={this.startCoordinate[1]}
                x2={this.startBezierHandle[0]}
                y2={this.startBezierHandle[1]}
              />
              <line
                className={styles.handleLine}
                stroke={handleLineColor}
                strokeWidth="1"
                strokeLinecap="round"
                x1={this.endCoordinate[0]}
                y1={this.endCoordinate[1]}
                x2={this.endBezierHandle[0]}
                y2={this.endBezierHandle[1]}
              />
              <path
                ...
                strokeLinecap="round"
                d={`M${this.startCoordinate} C${this.startBezierHandle} ${this.endBezierHandle} ${this.endCoordinate}`}
              />
              ...
              {enablePreview && (
                <circle
                  ...
                  strokeWidth={strokeWidth}
                  style={{
                    offsetPath: `path('M${this.startCoordinate} C${this.startBezierHandle} ${this.endBezierHandle} ${this.endCoordinate}')`,
                    animationTimingFunction: `cubic-bezier(${this.state.value.join(",")})`,
                    animationPlayState:
                      this.state.movingEndHandle || this.state.movingStartHandle ? "paused" : "running",
                  }}
                />
              )}
            </g>
